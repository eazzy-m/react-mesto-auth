...
function Main({ onAddPlace, onCardDelete, onCardLike, cards, onCardClick, onEditAvatar, onEditProfile }) {
    ...
    return (
        <main className="main">
            ...
            {/*        <h1 className="profile__info-__title">{user.name || "Жак-Ив Кусто"}</h1>*/}
            {/*        <button className="edit-button opacity button-open-__form"*/}
            {/*                type="button"*/}
            {/*                aria-label="изменить"*/}
            ...
            {/*    <button className="add-button opacity button-open-__form"*/}
            {/*            type="button"*/}
            {/*            aria-label="добавить"*/}
            {/*            onClick={onAddPlace}>*/}
